...
import { addCourse, deleteCourse, getAllCourse, getCourseById, getSelfCourses, searchCourse, updateCourse } from '../Controllers/course.controller.js'
...
router.put('/update-course/:courseId', jsonAuthMiddleware, isMentor, updateCourse)
